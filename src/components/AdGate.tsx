                    ...
                    <div className="aspect-video w-full bg-black/40 flex items-center justify-center relative group">
                        {status === 'loading' ? (
                            ...
                            <div className="flex flex-col items-center gap-6">
                                <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-full">
                                    <Zap className="w-12 h-12 text-green-500" />
                                </div>
                                <div className="text-center">
                                    <h3 className="text-3xl font-black tracking-tighter uppercase italic mb-2">Action Unlocked</h3>
                                    <p className="text-white/40 text-xs font-bold uppercase tracking-widest">You can now proceed without interruptions.</p>
                                </div>
                            </div>
                        )}
